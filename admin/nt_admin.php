...
function nt_settings_init(  ) { 
	...
	// add_settings_section( 'nt_API_section', __( 'API Engine', 'nitrogen' ), 'nt_api_section_callback', 'pluginPage' );

	// 	add_settings_field( 'nt_api_field', __( 'Source', 'nitrogen' ), 'nt_api_field_render', 'pluginPage', 'nt_API_section' );

	//SCRIPTS SETTINGS SECTION
	add_settings_section( 'nt_script_section', __( 'Custom Scripts for Oxygen', 'nitrogen' ), 'nt_script_section_callback', 'pluginPage' );

		add_settings_field( 'nt_script_field', __( 'Script', 'nitrogen' ), 'nt_script_field_render', 'pluginPage', 'nt_script_section' );
